...
<div class="container my-5">
    <div class="card shadow">
        ...
        <button style="position:fixed;bottom:50%;background-color:#0058b7;color:white;" class="btn" type="button" data-toggle="modal" data-target="#form"><i class="fa fa-plus" aria-hidden="true"></i></button>
